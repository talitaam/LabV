...
export function Home() {
  ...
  const testeListar = async () => {
    var teste = await ChatManager.listarMesas();
    console.log(teste);
  }*/

  
        //<button onClick={testeListar}>Botao</button>
        //<p>Teste: {conectado ? "conectado" : "desconectado"}</p>

  return (
    <div>
        <h3 className="page-title">Página Inicial</h3>
      <p>
